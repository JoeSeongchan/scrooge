# 1 "c:\\Users\\wordn\\arduino_projects\\sketch.ino"
...
void setup()
{
    ...
    pinMode(Relaypin1, 0x1); // 릴레이 제어 1번핀을 출력으로 설정
    pinMode(8, 0x2);
}
...
void relayOn()
{
    digitalWrite(Relaypin1, 0x0); // 릴레이 ON
    delay(2000); // 2초 대기
}

void relayOff()
{
    digitalWrite(Relaypin1, 0x1); // 릴레이 OFF
    delay(2000);
}
